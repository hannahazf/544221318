                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('skhun') is-invalid @enderror" name="skhun" value="{{ old('skhun') }}" placeholder="Masukkan skhun">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">no_ijazah</label>
                                <input type="text" class="form-control @error('no_ijazah') is-invalid @enderror" name="no_ijazah" value="{{ old('no_ijazah') }}" placeholder="Masukkan no ijazah">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">nama_ayah</label>
                                <input type="text" class="form-control @error('nama_ayah') is-invalid @enderror" name="nama_ayah" value="{{ old('nama_ayah') }}" placeholder="Masukkan nama_ayah">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">nama_ibu</label>
                                <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" value="{{ old('nama_ibu') }}" placeholder="Masukkan nama_ibu">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_wali') is-invalid @enderror" name="nama_wali" value="{{ old('nama_wali') }}" placeholder="Masukkan nama_wali">
